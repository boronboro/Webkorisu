...
import { TeleporterCollection } from "../entities/teleporter.js";
import { Laser, LasersAndButtonsCollection } from "../entities/laser.js";

class MoonLevelState {
    /**
     * @type MoonLevel
     */
    level;
    ...
    UpdateBodies() {
        ...
        this.level.acornCollection.UpdateBodies();
        ...
        this.level.teleporterCollection.Check(this.level.squirrelTeam);
        this.level.lasersAndButtonsCollection.Check(this.level.squirrelTeam);
    ...
    UpdateSprites() {
        this.level.acornCollection.UpdateSprites();
        this.level.squirrelTeam.UpdateSprites();
        this.level.movingPlatformCollection.UpdateSprites();
    }
}

class MoonLevelPlayState extends MoonLevelState {
    ...
    UpdateBodies() {
        ...
        if (this.level.acornCollection.allCollected) {
            this.level.state = new MoonLevelWinState(this.level);
        }
    }
}

class MoonLevelWinState extends MoonLevelState {
    /**
     * @type Announcement
     */
    announcement;
    ...
    UpdateSprites() {
        ...
        if (this.announcement.done) {
            ...
            this.level.state = new MoonLevelFadeoutState(this.level);
        }
    }
}

class MoonLevelFadeoutState extends MoonLevelState {
    /**
     * @type Fadeout
     */
    fadeout;
...
export default class MoonLevel extends Scene {
    ...
    /**
 * @type LasersAndButtonsCollection
 */
    lasersAndButtonsCollection;

    /**
     * @type TeleporterCollection
     */
    teleporterCollection;
            ...
            (object, objectgroup, x, y) => {
                switch (object.type) {
                    ...
                    case "acorn":
                        ...
                        break;
                    case "acorn-bubble":
                        this.acornCollection.AddBubble(x, y - 16);
                        break;
                    case "key-yellow":
                    ...
                    case "disappearing-platform":
                        ...
                        break;
                    case "teleporter":
                        this.teleporterCollection.AddTeleporter(object.polygonPoints || object.polylinePoints);
                        break;
                    case "laser":
                        this.lasersAndButtonsCollection.AddLaser(object.x, object.y - 32);
                        break;
                    case "laser-button":
                        this.lasersAndButtonsCollection.AddLaserButton(object.x, object.y - 32);
                        break;
                }
            },
            map);
    ...
    async Start() {
        ...
        await Laser.Load();
        this.lasersAndButtonsCollection = new LasersAndButtonsCollection();

        await MovingPlatform.Load();
        this.movingPlatformCollection = new MovingPlatformCollection();

        this.teleporterCollection = new TeleporterCollection();
        ...
        this.state = new MoonLevelPlayState(this);
        this.progress = 100;
    ...
    Stop() {
        ...
        Laser.Unload();
        this.lasersAndButtonsCollection = null;

        MovingPlatform.Unload();
        this.movingPlatformCollection = null;

        this.teleporterCollection = null;
